 ...
 * the real charged total (licences included), and Licences is the sum of the
 * daily accrual rows — already inside Gross and Net, shown for its own sake.
 */
  ...
  return (
    <div className={styles.row}>
      ...
      <Card padded={false} className={styles.card}>
        ...
        <div className={styles.sub}>real charged total · licences included</div>
      </Card>

      <Card padded={false} className={styles.card}>
        <div className={styles.kicker}>LICENCES · {rangeLabel}</div>
        <div className={styles.value}>{usd(kpis.licence, 2)}</div>
        <div className={styles.sub}>included in Gross and Net</div>
      </Card>
    </div>
  );
}
